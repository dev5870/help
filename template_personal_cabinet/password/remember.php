...
<head>
    ...
    <meta name="csrf-token" content="bbKcHHhJKYLdFZkrUiD2tBvWhym34mHTRuAVmNFs">
    <link rel="shortcut icon" href="/images/favicon.png">
    <title>Remember password | Buy and Sell Libra Coins Online</title>
...
<div class="page-ath-wrap">
    <div class="page-ath-content">
        <div class="page-ath-header">
            <a href="/" class="page-ath-logo"><img class="page-ath-logo-img" src="/images/logo.png" srcset="/images/logo2x.png" alt="Buy and Sell Libra Coins Online"></a>
        </div>

        <div class="page-ath-form">
            <h2 class="page-ath-heading">Thank you!
                <small>We sent the password to your mail.</small>
            </h2>

            <div class="text-success">You can log in to your account.</div>
            <div class="gaps-4x"></div>
            <p><a class="btn btn-primary" href="/login/index.php">Sign in</a></p>
        </div>
        ...
        <div class="page-ath-footer">
            <ul class="footer-links guttar-20px align-items-center">
                ...
                <li>&copy; 2019 Buy and Sell Libra Coins Online. © All Right Reserved.</li>
            </ul>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    jQuery(function () {
        ...
        if ($frv.length > 0) {
            $frv.validate({errorClass: "input-bordered-error error"});
        }
    });
</script>
